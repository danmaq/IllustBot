...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="body">
		...
		<h3>サポート</h3>
		<p>このWebアプリは制作期間1週間程度のアルファ版です。思わぬところからいろいろなバグが出てくるかもしれません。もしお気づきの点や、その他サポートしてほしい場合は<a href="http://twitter.com/danmaq" target="_blank">Twitter(@danmaq)</a>へ@ツイートしてください。</p>
		...
		<h3>作った理由とか</h3>
		<ul>
			<li><em>遺伝的アルゴリズムの学習および特性理解のため(現在構想中のブラゲ開発に必要な要素の一つなので、制作に先立つ基礎研究。悪く言うと実験台)</em></li>
			<li>GDグラフィックライブラリの学習のため(結構前からどういうものか知っていたが、実際に使ったのは初めて)</li>
