...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="body">
		...
		<p>
			...
			<a href="https://twitter.com/share" class="twitter-share-button" data-lang="ja" data-size="large" data-count="none" data-hashtags="IB01"><xsl:attribute name="data-text">ぼっとが<xsl:value-of select="@title" />を描いてみたようです。(レベル<xsl:value-of select="bot/@generation + 1" />)</xsl:attribute>このリンクでTwitterにて共有できます。</a>
		</p>
	</xsl:template>
