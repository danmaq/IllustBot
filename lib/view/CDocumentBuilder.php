...
require_once(IB01_LIB_ROOT . '/dao/CUser.php');
require_once(IB01_LIB_ROOT . '/dao/CTopic.php');
require_once(IB01_LIB_ROOT . '/dao/CTagTree.php');
...
class CDocumentBuilder
{
	...
	{
		return IB01_ROOT . preg_replace('/(\.|\/){2,}/', '\1', sprintf('/hlml/%s.php', $tag));
	}
